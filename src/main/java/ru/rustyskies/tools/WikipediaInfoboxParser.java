...
public class WikipediaInfoboxParser {
    ...
    public Map<Field, Object> parseInfobox(Country country) {
        // TODO
        return null;
    }

    public Map<Field, Object> parseInfobox(City city) {
        ...
        switch (city) {
            ...
            case Moscow:
                ...
                break;
            default: throw new RuntimeException("Unexpected city: " + city);
        }
...
//        System.out.println(parseInfobox(Main.City.Berlin));
